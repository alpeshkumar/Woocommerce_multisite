    ...
    class eCommerce_Gem_Features_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Widget to display features with icon and description including one main image.', 'woocommerce-multisite'),
            );
            parent::__construct('woocommerce-multisite-features', esc_html__('WC Multisite: Features', 'woocommerce-multisite'), $opts);
        }
        ...
        function form($instance) {
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #1', 'woocommerce-multisite'); ?></strong></span>
            </h4>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('feature_one')); ?>">
                    <?php esc_html_e('Title:', 'woocommerce-multisite'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('text_one')); ?>">
                    <?php esc_html_e('Short Description:', 'woocommerce-multisite'); ?>
                </label>
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #2', 'woocommerce-multisite'); ?></strong></span>
            </h4>
            ...
            <h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e('Feature #3', 'woocommerce-multisite'); ?></strong></span>
            </h4>
