	...
	class eCommerce_Gem_Latest_Products_Widget extends WP_Widget {
	    ...
	    function __construct() {
	    	$opts = array(
				...
				'description' => esc_html__( 'Widget to display latest product or featured products of Woo-Commerce with carousel', 'woocommerce-multisite' ),
    		);

			parent::__construct( 'woocommerce-multisite-latest-products', esc_html__( 'WC Multisite: Products Carousel', 'woocommerce-multisite' ), $opts );
	    }
	    ...
	    function form( $instance ) {
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id( 'product_type' ) ); ?>"><strong><?php _e( 'Product Type:', 'woocommerce-multisite' ); ?></strong></label>
    			<?php
	        ...
	        <p>
	        	<label for="<?php echo esc_attr( $this->get_field_name('product_number') ); ?>">
	        		<?php esc_html_e('Number of Products:', 'woocommerce-multisite'); ?>
	        	</label>
        ...
        function dropdown_product_type( $args ) {
    		...
    		$choices = array(
    			'latest' 	=> esc_html__( 'Latest', 'woocommerce-multisite' ),
    			'featured' 	=> esc_html__( 'Featured', 'woocommerce-multisite' ),
    		);
