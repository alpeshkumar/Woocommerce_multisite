	...
	class eCommerce_Gem_Advertisement_Widget extends WP_Widget {
		...
		function __construct() {
			$opts = array(
				...
				'description' => esc_html__( 'Widget to display advertisement. Recommended to use in Advertisement Below Slider area', 'woocommerce-multisite' ),
			);
			parent::__construct( 'woocommerce-multisite-advertisement', esc_html__( 'WC Multisite: Advertisement', 'woocommerce-multisite' ), $opts );
		}
		...
		function form( $instance ) {
			...
			$instance = wp_parse_args( (array) $instance, array(
				'title'       			=> '',
				'sub_title'    			=> '',
				'offer_percent'         => esc_html__( '50%', 'woocommerce-multisite' ),
				'offer_text'            => esc_html__( 'OFF', 'woocommerce-multisite' ),
				'button_text' 			=> esc_html__( 'Start Shopping', 'woocommerce-multisite' ),
				'button_url'  			=> '',
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><strong><?php esc_html_e( 'Title:', 'woocommerce-multisite' ); ?></strong></label>
				<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><strong><?php esc_html_e( 'Sub Title:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offer_percent' ) ); ?>"><strong><?php esc_html_e( 'Offer Percent:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offer_text' ) ); ?>"><strong><?php esc_html_e( 'Offer Text:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><strong><?php esc_html_e( 'Primary Button Text:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_url' ) ); ?>"><strong><?php esc_html_e( 'Primary Button URL:', 'woocommerce-multisite' ); ?></strong></label>
	        ...
	        <p>
	          <label for="<?php echo esc_attr( $this->get_field_id( 'content_position' ) ); ?>"><strong><?php esc_html_e( 'Content Position:', 'woocommerce-multisite' ); ?></strong></label>
				<?php
            ...
            <p>
              <label for="<?php echo esc_attr( $this->get_field_id( 'content_style' ) ); ?>"><strong><?php esc_html_e( 'Content style:', 'woocommerce-multisite' ); ?></strong></label>
    			<?php
			...
			<div class="cover-image">
                <label for="<?php echo esc_attr( $this->get_field_id( 'bg_pic' ) ); ?>">
                    <strong><?php esc_html_e( 'Background Image:', 'woocommerce-multisite' ); ?></strong>
                </label>
                ...
                <div class="rtam-preview-wrap" <?php echo $wrap_style; ?>>
                    <img src="<?php echo esc_url( $bg_pic ); ?>" alt="<?php esc_attr_e( 'Preview', 'woocommerce-multisite' ); ?>" />
                </div><!-- .rtam-preview-wrap -->
                <input type="button" class="select-img button button-primary" value="<?php esc_html_e( 'Upload', 'woocommerce-multisite' ); ?>" data-uploader_title="<?php esc_html_e( 'Select Background Image', 'woocommerce-multisite' ); ?>" data-uploader_button_text="<?php esc_html_e( 'Choose Image', 'woocommerce-multisite' ); ?>" />
                <input type="button" value="<?php echo esc_attr_x( 'X', 'Remove Button', 'woocommerce-multisite' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $delete_button ); ?>" />
            </div>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'disable_overlay' ); ?>"><?php esc_html_e( 'Disable overlay of the image', 'woocommerce-multisite' ); ?></label>
            </p>
		<?php
		} 
	    ...
	    function dropdown_content_position( $args ) {
			...
			$choices = array(
				'left' 		=> esc_html__( 'Left', 'woocommerce-multisite' ),
				'right' 	=> esc_html__( 'Right', 'woocommerce-multisite' ),
			);
        ...
        function dropdown_content_style( $args ) {
    		...
    		$choices = array(
    			'style-1' 	=> esc_html__( 'Style One', 'woocommerce-multisite' ),
    			'style-2' 	=> esc_html__( 'Style Two', 'woocommerce-multisite' ),
    		);
