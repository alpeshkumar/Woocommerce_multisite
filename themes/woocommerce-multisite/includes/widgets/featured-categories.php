	...
	class eCommerce_Gem_Featured_Categories_Widget extends WP_Widget {
	    ...
	    function __construct() {
	    	$opts = array(
				...
				'description' => esc_html__( 'Widget to display featured categories of Woo-Commerce with carousel', 'woocommerce-multisite' ),
    		);

			parent::__construct( 'woocommerce-multisite-featured-categories', esc_html__( 'WC Multisite: Featured Categories', 'woocommerce-multisite' ), $opts );
	    }
	    ...
	    function form( $instance ) {
	        ...
	        $instance = wp_parse_args( (array) $instance, array(
				'title'          		=> '',
				'product_category'		=> '',
				'view_details'          => esc_html__( 'View Details', 'woocommerce-multisite' ),
				'featured_cats' 		=> array(),
				'show_counts'		   	=> 0,
				'disable_carousel'   	=> 0,
            ...
            <p>
				<label for="<?php echo  esc_attr( $this->get_field_id( 'product_category' ) ); ?>"><strong><?php esc_html_e( 'Select Category:', 'woocommerce-multisite' ); ?></strong></label>
				...
				<div class="multiple-checkbox-holder">
					...
					if( !empty( $product_categories ) ){
						...
						esc_html_e('No product categories found', 'woocommerce-multisite');

					} ?>
				</div>

				<small>
		        	<?php esc_html_e('Categories selected here will be used as featured category at frontend.', 'woocommerce-multisite'); ?>	
		        </small>
        	</p>

        	<p>
        		<label for="<?php echo esc_attr( $this->get_field_id( 'view_details' ) ); ?>"><strong><?php esc_html_e( 'View Detail Text:', 'woocommerce-multisite' ); ?></strong></label>
	        ...
	        <p>
	            ...
	            <label for="<?php echo $this->get_field_id( 'show_counts' ); ?>"><?php esc_html_e( 'Show Product Counts', 'woocommerce-multisite' ); ?></label>
	        </p>
	        ...
	        <p>
	            ...
	            <label for="<?php echo $this->get_field_id( 'disable_carousel' ); ?>"><?php esc_html_e( 'Disable Carousel Mode', 'woocommerce-multisite' ); ?></label>
	        </p>
