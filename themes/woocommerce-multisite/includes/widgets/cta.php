	...
	class eCommerce_Gem_CTA_Widget extends WP_Widget {
		...
		function __construct() {
			$opts = array(
				...
				'description' => esc_html__( 'Call To Action Widget', 'woocommerce-multisite' ),
			);
			parent::__construct( 'woocommerce-multisite-cta', esc_html__( 'WC Multisite: CTA', 'woocommerce-multisite' ), $opts );
		}
		...
		function form( $instance ) {
			...
			$instance = wp_parse_args( (array) $instance, array(
				...
				'button_text' 			=> esc_html__( 'Purchase Now', 'woocommerce-multisite' ),
				'button_url'  			=> '',
				'bg_pic'      			=> '',
			) );
