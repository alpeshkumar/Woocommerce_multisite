    ...
    class eCommerce_Gem_Newsletter_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Newsletter Widget', 'woocommerce-multisite'),
            );
            parent::__construct('woocommerce-multisite-newsletter', esc_html__('WC Multisite: Newsletter', 'woocommerce-multisite'), $opts);
        }
                        ...
                        <?php if (!empty($title) || !empty($sub_title)) { ?>
                            ...
                            <div class="newsletter-text">
                                ...
                                <span class="newsletter-icon">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/envelope.png" alt="<?php esc_attr_e('newsletter', 'woocommerce-multisite'); ?>">
                                </span>
        ...
        function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('shortcode')); ?>"><strong><?php esc_html_e('Newsletter Shortcode:', 'woocommerce-multisite'); ?></strong></label>
                ...
                <small>
                    <?php esc_html_e('Shortcode of MailChimp or other mailing applications can be used.', 'woocommerce-multisite'); ?>	
                </small>
            </p>
            <?php
        }
