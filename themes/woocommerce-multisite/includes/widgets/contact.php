	...
	class eCommerce_Gem_Contact_Widget extends WP_Widget {
		...
		function __construct() {
			$opts = array(
					...
					'description' => esc_html__( 'Widget to display contact informations like address, email and phone with icon. Recommended to use in footer or sidebar only', 'woocommerce-multisite' ),
			);
			parent::__construct( 'woocommerce-multisite-contact', esc_html__( 'WC Multisite: Contact', 'woocommerce-multisite' ), $opts );
		}
		...
		function form( $instance ) {
            ...
            <p>
    	        <small>
    	        	...
    	        	<?php printf( esc_html__( 'ET-LINE icons are used for icon of each blocks. You can find icon code %1$shere%2$s.', 'woocommerce-multisite' ), '<a href="http://rhythm.nikadevs.com/content/icons-et-line" target="_blank">', '</a>' ); ?>
    	        </small>
            </p>

			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #1', 'woocommerce-multisite' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_one" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_name('text_one') ); ?>">
					<?php esc_html_e('Text:', 'woocommerce-multisite'); ?>
				</label>
			...
			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #2', 'woocommerce-multisite' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_two" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #3', 'woocommerce-multisite' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_three" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'woocommerce-multisite' ); ?></strong></label>
			...
			<h4 class="widefat widget-custom-info">
                <span class="field-label"><strong><?php esc_html_e( 'Block #4', 'woocommerce-multisite' ); ?></strong></span>
            </h4>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( "icon_four" ) ); ?>"><strong><?php esc_html_e( 'Icon:', 'woocommerce-multisite' ); ?></strong></label>
