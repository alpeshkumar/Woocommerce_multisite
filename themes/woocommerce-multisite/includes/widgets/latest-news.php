    ...
    class eCommerce_Gem_Latest_News_Widget extends WP_Widget {
        ...
        function __construct() {
            $opts = array(
                ...
                'description' => esc_html__('Widget to dispaly latest posts with thumbnail, title, short content and read more link', 'woocommerce-multisite'),
            );

            parent::__construct('woocommerce-multisite-latest-news', esc_html__('WC Multisite: Latest News', 'woocommerce-multisite'), $opts);
        }
                                        ...
                                        <?php if (has_post_thumbnail()) : ?>
                                            <div class="blog-thumbnail">
                                                <a href="<?php the_permalink(); ?>">
                                                    <?php the_post_thumbnail('woocommerce-multisite-common'); ?>
                                                </a>
                                            </div><!-- .blog-thumbnail -->
                                        <?php endif; ?>
        ...
        function form($instance) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_category')); ?>"><strong><?php esc_html_e('Select Category:', 'woocommerce-multisite'); ?></strong></label>
                <?php
                $cat_args = array(
                    'orderby' => 'name',
                    'hide_empty' => 0,
                    ...
                    'show_option_all' => esc_html__('All Categories', 'woocommerce-multisite'),
                );
                wp_dropdown_categories($cat_args);
                ?>
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('exclude_categories')); ?>"><strong><?php esc_html_e('Exclude Categories:', 'woocommerce-multisite'); ?></strong></label>
                ...
                <small>
                    <?php esc_html_e('Enter category id seperated with comma. Posts from these categories will be excluded from latest post listing.', 'woocommerce-multisite'); ?>	
                </small>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('excerpt_length')); ?>">
                    <?php esc_html_e('Excerpt Length:', 'woocommerce-multisite'); ?>
                </label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id('disable_date'); ?>"><?php esc_html_e('Hide Posted Date', 'woocommerce-multisite'); ?></label>
            </p>
            <?php
        }
