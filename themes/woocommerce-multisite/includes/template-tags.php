...
if ( ! function_exists( 'ecommerce_gem_posted_on' ) ) :
	...
	function ecommerce_gem_posted_on() {
		...
		if ( 'post' === get_post_type() ) {
			...
			$categories_list = get_the_category_list( esc_html_x( ', ', 'list item separator', 'woocommerce-multisite' ) );
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'woocommerce-multisite' ),
						array(
							'span' => array(
								'class' => array(),
							),
...
if ( ! function_exists( 'ecommerce_gem_entry_footer' ) ) :
	...
	function ecommerce_gem_entry_footer() {
		...
		if ( 'post' === get_post_type() && is_single() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'woocommerce-multisite' ) );
			if ( $tags_list ) {
			...
			edit_post_link(
				sprintf(
					wp_kses(
						...
						__( 'Edit <span class="screen-reader-text">%s</span>', 'woocommerce-multisite' ),
						array(
							'span' => array(
								'class' => array(),
							),
