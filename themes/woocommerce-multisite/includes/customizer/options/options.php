...
$wp_customize->add_control(
	new WP_Customize_Color_Control(
		...
		array(
			'label'       => esc_html__( 'Primary Color', 'woocommerce-multisite' ),
			'description' => esc_html__( 'Applied to main color of site.', 'woocommerce-multisite' ),
			'section'     => 'colors',	
		)
	)
);
...
$wp_customize->add_panel( 'theme_option_panel',
	array(
		'title'      => esc_html__( 'Theme Options', 'woocommerce-multisite' ),
		'priority'   => 100,
	)
);
