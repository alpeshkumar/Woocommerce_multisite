...
$wp_customize->add_panel( 'slider_option_panel',
	array(
		'title'      => esc_html__( 'Featured Slider Options', 'woocommerce-multisite' ),
		'priority'   => 100,
	)
);
...
$wp_customize->add_section( 'section_slider',
	array(
		'title'      => esc_html__( 'Slider On/Off', 'woocommerce-multisite' ),
...
$wp_customize->add_control( 'theme_options[slider_status]',
	array(
		'label'    			=> esc_html__( 'Enable Slider', 'woocommerce-multisite' ),
...
for ( $i = 1; $i <= $slider_number; $i++ ) {
	...
	$wp_customize->add_control( 
		new eCommerce_Gem_Info( 
			...
			array(
				'label' 			=> esc_html__( 'Slide ', 'woocommerce-multisite' ) . ' - ' . $i,
				'section' 			=> 'section_slider',
				'priority' 			=> 100,
	...
	$wp_customize->add_control( "theme_options[slider_page_$i]",
		array(
			'label'           => esc_html__( 'Select Page', 'woocommerce-multisite' ),
			'section'         => 'section_slider',
			'type'            => 'dropdown-pages',
			'active_callback' => 'ecommerce_gem_is_featured_slider_active',
			'priority' 		  => 100,
	...
	$wp_customize->add_control( "theme_options[caption_position_$i]",
		array(
			'label'           => esc_html__( 'Caption Position', 'woocommerce-multisite' ),
			'section'         => 'section_slider',
			'type'            => 'select',
			'choices'         => array(
				'left'     => esc_html__( 'Left', 'woocommerce-multisite' ),
				'right'    => esc_html__( 'Right', 'woocommerce-multisite' ),
				'center'   => esc_html__( 'Center', 'woocommerce-multisite' ),
			),
			'active_callback' => 'ecommerce_gem_is_featured_slider_active',
			'priority' 		  => 100,
		)
	...
	$wp_customize->add_setting( "theme_options[button_text_$i]",
		array(
			'default'           => esc_html__( 'Shop Now', 'woocommerce-multisite' ),
			'sanitize_callback' => 'sanitize_text_field',
		)
	);
	$wp_customize->add_control( "theme_options[button_text_$i]",
		array(
			'label'    => esc_html__( 'Button Text', 'woocommerce-multisite' ),
			'section'  => 'section_slider',
			'type'     => 'text',
			'active_callback' => 'ecommerce_gem_is_featured_slider_active',
			'priority' => 100,
	...
	$wp_customize->add_control( "theme_options[button_link_$i]",
		array(
			'label'    => esc_html__( 'Button Link', 'woocommerce-multisite' ),
			'section'  => 'section_slider',
			'type'     => 'text',
			'active_callback' => 'ecommerce_gem_is_featured_slider_active',
			'priority' => 100,
...
$wp_customize->add_section( 'section_slider_options',
	array(
		'title'      => esc_html__( 'Slider Setting', 'woocommerce-multisite' ),
		'panel'      => 'slider_option_panel',
	)
);
...
$wp_customize->add_control( 'theme_options[slider_transition_effect]',
	array(
		'label'           => esc_html__( 'Transition Effect', 'woocommerce-multisite' ),
		'section'         => 'section_slider_options',
		'type'            => 'select',
		'choices'         => array(
			'fade'       => esc_html__( 'Fade', 'woocommerce-multisite' ),
			'scrollHorz' => esc_html__( 'Scroll', 'woocommerce-multisite' ),
		),
	)
);
...
$wp_customize->add_control( 'theme_options[slider_transition_delay]',
	array(
		'label'           => esc_html__( 'Transition Delay', 'woocommerce-multisite' ),
		'description'     => esc_html__( 'in seconds', 'woocommerce-multisite' ),
		'section'         => 'section_slider_options',
		'type'            => 'number',
...
$wp_customize->add_control( 'theme_options[slider_pager_status]',
	array(
		'label'           => esc_html__( 'Show Pager', 'woocommerce-multisite' ),
		'section'         => 'section_slider_options',
		'type'            => 'checkbox',
	)
);
...
$wp_customize->add_control( 'theme_options[slider_autoplay_status]',
	array(
		'label'           => esc_html__( 'Enable Autoplay', 'woocommerce-multisite' ),
		'section'         => 'section_slider_options',
		'type'            => 'checkbox',
	)
);