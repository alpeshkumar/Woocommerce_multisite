...
$wp_customize->add_section( 'section_layout',
	array(
		'title'      => esc_html__( 'Layout Options', 'woocommerce-multisite' ),
		'priority'   => 100,
...
$wp_customize->add_control( 'theme_options[enable_sticky_sidebar]',
	array(
		'label'    			=> esc_html__( 'Enable Sticky Sidebar', 'woocommerce-multisite' ),
...
$wp_customize->add_control( 'theme_options[global_layout]',
	array(
		'label'    => esc_html__( 'Global Layout', 'woocommerce-multisite' ),
		'section'  => 'section_layout',
		'type'     => 'radio',
		'priority' => 100,
		'choices'  => array(
...
$wp_customize->add_control( 'theme_options[excerpt_length]',
	array(
		'label'       => esc_html__( 'Excerpt Length', 'woocommerce-multisite' ),
		'description' => esc_html__( 'in words', 'woocommerce-multisite' ),
		'section'     => 'section_layout',
		'type'        => 'number',
		'priority'    => 100,
...
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
		'label'    => esc_html__( 'Read More Text', 'woocommerce-multisite' ),
		'section'  => 'section_layout',
		'type'     => 'text',
		'priority' => 100,
	)
