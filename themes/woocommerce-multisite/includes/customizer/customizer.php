...
function ecommerce_gem_custom_customize_enqueue() {
	wp_enqueue_style( 'woocommerce-multisite-customize', get_template_directory_uri() . '/includes/customizer/css/customize-controls.css' );

	wp_enqueue_script( 'woocommerce-multisite-customize-controls', get_template_directory_uri() . '/includes/upgrade-to-pro/customize-controls.js', array( 'customize-controls' ) );

	wp_enqueue_style( 'woocommerce-multisite-customize-controls', get_template_directory_uri() . '/includes/upgrade-to-pro/customize-controls.css' );
}
